...
constexpr uint32_t RPTB_LABEL_CONST16 = 0xB5800000;
constexpr uint32_t SAVE_FLAG_VALUE = 0xE6400000;
constexpr uint32_t SETFLG_FLAG_VALUE = 0xE6000000;
constexpr uint32_t SUBF32_RAH_RBH_RCH = 0xE7200000;
...
constexpr uint32_t MPYF64_RD_RE_RF_MOV32_RAL_MEM32 = 0xE3800000;
constexpr uint32_t MPYF64_RD_RE_RF_MOV32_MEM32_RAL = 0xE0800000;
constexpr uint32_t ADDF64_RD_RE_RF_MOV32_RAL_MEM32 = 0xE3900000;
constexpr uint32_t ADDF64_RD_RE_RF_MOV32_MEM32_RAL = 0xE0900000;
constexpr uint32_t SUBF64_RD_RE_RF_MOV32_RAL_MEM32 = 0xE3A00000;
constexpr uint32_t SUBF64_RD_RE_RF_MOV32_MEM32_RAL = 0xE0A00000;
constexpr uint32_t MACF64_R3_R2_RD_RE_RF_MOV32_RAL_MEM32 = 0xE3B00000;
constexpr uint32_t MACF64_R7_R6_RD_RE_RF_MOV32_RAL_MEM32 = 0xE3E00000;
constexpr uint32_t MPYF64_RD_RE_RF_MOV32_RAH_MEM32 = 0xE3400000;
constexpr uint32_t MPYF64_RD_RE_RF_MOV32_MEM32_RAH = 0xE0400000;
constexpr uint32_t ADDF64_RD_RE_RF_MOV32_RAH_MEM32 = 0xE3500000;
constexpr uint32_t ADDF64_RD_RE_RF_MOV32_MEM32_RAH = 0xE0500000;
constexpr uint32_t SUBF64_RD_RE_RF_MOV32_RAH_MEM32 = 0xE3600000;
constexpr uint32_t SUBF64_RD_RE_RF_MOV32_MEM32_RAH = 0xE0600000;
constexpr uint32_t MACF64_R3_R2_RD_RE_RF_MOV32_RAH_MEM32 = 0xE3700000;
constexpr uint32_t MACF64_R7_R6_RD_RE_RF_MOV32_RAH_MEM32 = 0xE3D00000;
constexpr uint32_t MPYF64_RA_RB_RC_ADDF64_RD_RE_RF = 0xE7C00000;
...
constexpr uint32_t VASHR32_VRA_5BIT = 0xE6F20800;
...
constexpr uint16_t VCADD_VR7_VR6_VR5_VR4 = 0xE52A;
constexpr uint32_t VCADD_VR5_VR4_VR3_VR2_VMOV32_VRA_MEM32 = 0xE3F80000;
constexpr uint16_t VCCMAC_VR5_VR4_VR3_VR2_VR1_VR0 = 0xE50F;
constexpr uint32_t VCCMAC_VR5_VR4_VR3_VR2_VR1_VR0_VMOV32_VRA_MEM32 = 0xE3F71000;
constexpr uint32_t VCCMAC_VR7_VR6_VR5_VR4_MEM32_XAR7_POSTINC = 0xE2512F00;
constexpr uint16_t VCCMPY_VR3_VR2_VR1_VR0 = 0xE50E;
...
constexpr uint16_t VCMAC_VR5_VR4_VR3_VR2_VR1_VR0 = 0xE501;
constexpr uint32_t VCMAC_VR7_VR6_VR5_VR4_MEM32_XAR7_POSTINC = 0xE2510000;
constexpr uint32_t VCMAC_VR5_VR4_VR3_VR2_VR1_VR0_VMOV32_VRA_MEM32 = 0xE3F70000;
constexpr uint32_t VCMAG_VRB_VRA = 0xE6F20400;
constexpr uint16_t VCMPY_VR3_VR2_VR1_VR0 = 0xE500;
constexpr uint32_t VCMPY_VR3_VR2_VR1_VR0_VMOV32_VRA_MEM32 = 0xE2CA0000;
...
constexpr uint32_t MASK_FF800000 = 0xFF800000;
