...
GenerateInstructionVector() {
  std::vector<std::optional<std::shared_ptr<Instruction>>> vec = {
      ...
      std::make_shared<Mov32Loc32Imm16A>(),
      std::make_shared<Mov32Loc32Imm16B>(),
      std::make_shared<Mov32Mem32Rah>(),
      std::make_shared<Mov32Mem32Stf>(),
      std::make_shared<Mov32RahMem32Cndf>(),
      std::make_shared<Mov32RahRbhCndf>(),
      std::make_shared<Mov32StfMem32>(),
      std::make_shared<Movd32RahMem32>(),
      ...
      std::make_shared<VccmpyVr3Vr2Vr1Vr0Vmov32VraMem32Load>(),
      ...
      std::make_shared<SwapfRahRbhCndf>(),
      std::make_shared<TesttfCndf>(),
      std::make_shared<Ui16tof32RahMem16>(),
      std::make_shared<Ui16tof32RahRbh>(),
      std::make_shared<Ui32tof32RahMem32>(),
      std::make_shared<Ui32tof32RahRbh>(),
      ...
      std::make_shared<Mpyf64RdReRfMov32RalMem32>(),
      std::make_shared<Mpyf64RdReRfMov32Mem32Ral>(),
      std::make_shared<Addf64RdReRfMov32RalMem32>(),
      std::make_shared<Addf64RdReRfMov32Mem32Ral>(),
      std::make_shared<Subf64RdReRfMov32RalMem32>(),
      std::make_shared<Subf64RdReRfMov32Mem32Ral>(),
      std::make_shared<Macf64R3R2RdReRfMov32RalMem32>(),
      std::make_shared<Macf64R7R6RdReRfMov32RalMem32>(),
      std::make_shared<Mpyf64RdReRfMov32RahMem32>(),
      std::make_shared<Mpyf64RdReRfMov32Mem32Rah>(),
      std::make_shared<Addf64RdReRfMov32RahMem32>(),
      std::make_shared<Addf64RdReRfMov32Mem32Rah>(),
      std::make_shared<Subf64RdReRfMov32RahMem32>(),
      std::make_shared<Subf64RdReRfMov32Mem32Rah>(),
      std::make_shared<Macf64R3R2RdReRfMov32RahMem32>(),
      std::make_shared<Macf64R7R6RdReRfMov32RahMem32>(),
      std::make_shared<Mpyf64RaRbRcAddf64RdReRf>(),
      std::make_shared<Mpyf64RaRbRcSubf64RdReRf>(),
      std::make_shared<Mpyf64RaRbRc>(),
      std::make_shared<Addf64RaRbRc>(),
      std::make_shared<Subf64RaRbRc>(),
      std::make_shared<Mpyf64RaRb16F>(),
      std::make_shared<Addf64RaRb16F>(),
      std::make_shared<Subf64Ra16FRb>(),
      std::make_shared<Cmpf64RaRb>(),
      std::make_shared<Cmpf64Ra16F>(),
      std::make_shared<Cmpf64Ra0>(),
      std::make_shared<Maxf64RaRb>(),
      std::make_shared<Maxf64RaRbMov64RcRd>(),
      std::make_shared<Maxf64Ra16F>(),
      std::make_shared<Minf64RaRb>(),
      std::make_shared<Minf64RaRbMov64RcRd>(),
      std::make_shared<Minf64Ra16F>(),
      std::make_shared<F64toi32RahRb>(),
      std::make_shared<F64toui32RahRb>(),
      std::make_shared<I32tof64RaMem32>(),
      ...
      std::make_shared<VcaddVr7Vr6Vr5Vr4>(),
      std::make_shared<VcaddVr5Vr4Vr3Vr2Vmov32VraMem32>(),
      std::make_shared<VccmacVr5Vr4Vr3Vr2Vr1Vr0>(),
      std::make_shared<VccmacVr5Vr4Vr3Vr2Vr1Vr0Vmov32VraMem32>(),
      ...
      std::make_shared<VcmpyVr3Vr2Vr1Vr0Vmov32Mem32Vra>(),
      std::make_shared<VcmpyVr3Vr2Vr1Vr0Vmov32VraMem32>(),
      std::make_shared<Vcshl16Vra4bit>(),
...
uint8_t Addf32RdhRehRfhMov32Mem32Rah::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Addf32RdhRehRfhMov32Mem32Rah::SetMem32(const uint8_t mem32) {
...
uint8_t Addf32RdhRehRfhMov32RahMem32::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Addf32RdhRehRfhMov32RahMem32::SetMem32(const uint8_t mem32) {
  return FpuSetMem(opcode, mem32);
}
...
uint8_t I32tof32RahMem32::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t I32tof32RahMem32::SetMem32(const uint8_t mem32) {
  return FpuSetMem(opcode, mem32);
}
...
uint8_t Macf32R3hR2hRdhRehRfhMov32RahMem32::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Macf32R3hR2hRdhRehRfhMov32RahMem32::SetMem32(const uint8_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Macf32R7hR3hMem32Xar7Postinc
uint8_t Macf32R7hR3hMem32Xar7Postinc::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Macf32R7hR3hMem32Xar7Postinc::SetMem32(const uint8_t mem32) {
  return FpuSetMem(opcode, mem32);
}
...
uint8_t Macf32R7hR6hRdhRehRfhMov32RahMem32::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Macf32R7hR6hRdhRehRfhMov32RahMem32::SetMem32(const uint8_t mem32) {
  return FpuSetMem(opcode, mem32);
}
...
// Mov32Loc32Imm16A
uint8_t Mov32Loc32Imm16A::GetLoc32(const uint32_t data) {
  return (data & 0xFF0000u) >> 16;
}

uint32_t Mov32Loc32Imm16A::SetLoc32(const uint8_t loc32) {
  return opcode | static_cast<uint32_t>(loc32) << 16;
}

uint16_t Mov32Loc32Imm16A::GetImm16(const uint32_t data) {
  return data & 0xFFFFu;
}

uint32_t Mov32Loc32Imm16A::SetImm16(const uint16_t imm16) {
  return opcode | imm16;
}

// Mov32Loc32Imm16B
uint8_t Mov32Loc32Imm16B::GetLoc32(const uint32_t data) {
  return (data & 0xFF0000u) >> 16;
}

uint32_t Mov32Loc32Imm16B::SetLoc32(const uint8_t loc32) {
  return opcode | static_cast<uint32_t>(loc32) << 16;
}

uint16_t Mov32Loc32Imm16B::GetImm16(const uint32_t data) {
  return data & 0xFFFFu;
}

uint32_t Mov32Loc32Imm16B::SetImm16(const uint16_t imm16) {
  return opcode | imm16;
}

// Mov32Mem32Rah
uint8_t Mov32Mem32Rah::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Mov32Mem32Rah::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Mov32Mem32Rah::GetMem32(const uint32_t data) { return FpuGetMem(data); }

uint32_t Mov32Mem32Rah::SetMem32(const uint8_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Mov32Mem32Stf
uint8_t Mov32Mem32Stf::GetMem32(const uint32_t data) { return FpuGetMem(data); }

uint32_t Mov32Mem32Stf::SetMem32(const uint8_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Mov32RahMem32Cndf
uint8_t Mov32RahMem32Cndf::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Mov32RahMem32Cndf::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Mov32RahMem32Cndf::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Mov32RahMem32Cndf::SetMem32(const uint8_t mem32) {
  return FpuSetMem(opcode, mem32);
}

uint8_t Mov32RahMem32Cndf::GetCond(const uint32_t data) {
  return (data & 0xF0000u) >> 16;
}

uint32_t Mov32RahMem32Cndf::SetCond(const uint8_t cond) {
  return opcode | (cond & 0xFu) << 16;
}

// Mov32RahRbhCndf
uint8_t Mov32RahRbhCndf::GetRegA(const uint32_t data) {
  return FpuGetRegA_I(data);
}

uint32_t Mov32RahRbhCndf::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t Mov32RahRbhCndf::GetRegB(const uint32_t data) {
  return FpuGetRegB_I(data);
}

uint32_t Mov32RahRbhCndf::SetRegB(const uint8_t b) {
  return FpuSetRegB_I(opcode, b);
}

uint8_t Mov32RahRbhCndf::GetCond(const uint32_t data) {
  return (data & 0xF0000u) >> 16;
}

uint32_t Mov32RahRbhCndf::SetCond(const uint8_t cond) {
  return opcode | (cond & 0xFu) << 16;
}

// Mov32StfMem32
uint8_t Mov32StfMem32::GetMem32(const uint32_t data) { return FpuGetMem(data); }

uint32_t Mov32StfMem32::SetMem32(const uint8_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Movd32RahMem32
uint8_t Movd32RahMem32::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Movd32RahMem32::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Movd32RahMem32::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Movd32RahMem32::SetMem32(const uint8_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// MovizRah16FHiHex
uint8_t MovizRah16FHiHex::GetRegA(const uint32_t data) {
  return FpuGetRegA_I(data);
}

uint32_t MovizRah16FHiHex::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint16_t MovizRah16FHiHex::GetImm16Hex(const uint32_t data) {
  return (data & 0x7FFF8u) >> 3;
}

uint32_t MovizRah16FHiHex::SetImm16Hex(const uint16_t imm16_hex) {
  return opcode | imm16_hex << 3;
}

// Movst0Flag
uint8_t Movst0Flag::GetFlag(const uint32_t data) { return data & 0xFFu; }

uint32_t Movst0Flag::SetFlag(const uint8_t flag) { return opcode | flag; }

// MovizRah16FLoHex
uint8_t MovizRah16FLoHex::GetRegA(const uint32_t data) {
  return FpuGetRegA_I(data);
}

uint32_t MovizRah16FLoHex::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint16_t MovizRah16FLoHex::GetImm16Hex(const uint32_t data) {
  return (data & 0x7FFF8u) >> 3;
}
...
// SwapfRahRbhCndf
uint8_t SwapfRahRbhCndf::GetRegA(const uint32_t data) {
  return FpuGetRegA_I(data);
}

uint32_t SwapfRahRbhCndf::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t SwapfRahRbhCndf::GetRegB(const uint32_t data) {
  return FpuGetRegB_I(data);
}

uint32_t SwapfRahRbhCndf::SetRegB(const uint8_t b) {
  return FpuSetRegB_I(opcode, b);
}

uint8_t SwapfRahRbhCndf::GetCndf(const uint32_t data) {
  return data >> 16 & 0xFu;
}

uint32_t SwapfRahRbhCndf::SetCndf(const uint8_t cndf) {
  return opcode | (cndf & 0xFu) << 16;
}

// TesttfCndf
uint8_t TesttfCndf::GetCndf(const uint32_t data) { return data & 0xFu; }

uint32_t TesttfCndf::SetCndf(const uint8_t cndf) {
  return opcode | (cndf & 0xFu);
}

// Ui16tof32RahMem16
uint8_t Ui16tof32RahMem16::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Ui16tof32RahMem16::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Ui16tof32RahMem16::GetMem16(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Ui16tof32RahMem16::SetMem16(const uint8_t mem16) {
  return FpuSetMem(opcode, mem16);
}

// Ui16tof32RahRbh
uint8_t Ui16tof32RahRbh::GetRegA(const uint32_t data) {
  return FpuGetRegA_I(data);
}

uint32_t Ui16tof32RahRbh::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t Ui16tof32RahRbh::GetRegB(const uint32_t data) {
  return FpuGetRegB_I(data);
}

uint32_t Ui16tof32RahRbh::SetRegB(const uint8_t b) {
  return FpuSetRegB_I(opcode, b);
}

// Ui32tof32RahMem32
uint8_t Ui32tof32RahMem32::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Ui32tof32RahMem32::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Ui32tof32RahMem32::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Ui32tof32RahMem32::SetMem32(const uint8_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Ui32tof32RahRbh
uint8_t Ui32tof32RahRbh::GetRegA(const uint32_t data) {
  return FpuGetRegA_I(data);
}

uint32_t Ui32tof32RahRbh::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t Ui32tof32RahRbh::GetRegB(const uint32_t data) {
  return FpuGetRegB_I(data);
}

uint32_t Ui32tof32RahRbh::SetRegB(const uint8_t b) {
  return FpuSetRegB_I(opcode, b);
}

// ZeroRah
uint8_t ZeroRah::GetRegA(const uint32_t data) { return data & 0x7u; }

uint32_t ZeroRah::SetRegA(const uint8_t a) { return opcode | (a & 0x7u); }

// Mov32RalMem32Cndf
uint8_t Mov32RalMem32Cndf::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Mov32RalMem32Cndf::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Mov32RalMem32Cndf::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Mov32RalMem32Cndf::SetMem32(const uint8_t mem32) {
  return FpuSetMem(opcode, mem32);
}

uint8_t Mov32RalMem32Cndf::GetCndf(const uint32_t data) {
  return (data >> 16) & 0xFu;
}
...
// Mpyf64RdReRfMov32RalMem32
// Format II: RegA=bits 10-8, RegD=bits 13-11, RegE=bits 16-14, RegF=bits 19-17,
// Mem=bits 7-0
uint8_t Mpyf64RdReRfMov32RalMem32::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Mpyf64RdReRfMov32RalMem32::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Mpyf64RdReRfMov32RalMem32::GetRegD(const uint32_t data) {
  return FpuGetRegD_II(data);
}

uint32_t Mpyf64RdReRfMov32RalMem32::SetRegD(const uint8_t d) {
  return FpuSetRegD_II(opcode, d);
}

uint8_t Mpyf64RdReRfMov32RalMem32::GetRegE(const uint32_t data) {
  return FpuGetRegE_II(data);
}

uint32_t Mpyf64RdReRfMov32RalMem32::SetRegE(const uint8_t e) {
  return FpuSetRegE_II(opcode, e);
}

uint8_t Mpyf64RdReRfMov32RalMem32::GetRegF(const uint32_t data) {
  return FpuGetRegF_II(data);
}

uint32_t Mpyf64RdReRfMov32RalMem32::SetRegF(const uint8_t f) {
  return FpuSetRegF_II(opcode, f);
}

uint16_t Mpyf64RdReRfMov32RalMem32::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Mpyf64RdReRfMov32RalMem32::SetMem32(const uint16_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Mpyf64RdReRfMov32Mem32Ral
uint8_t Mpyf64RdReRfMov32Mem32Ral::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Mpyf64RdReRfMov32Mem32Ral::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Mpyf64RdReRfMov32Mem32Ral::GetRegD(const uint32_t data) {
  return FpuGetRegD_II(data);
}

uint32_t Mpyf64RdReRfMov32Mem32Ral::SetRegD(const uint8_t d) {
  return FpuSetRegD_II(opcode, d);
}

uint8_t Mpyf64RdReRfMov32Mem32Ral::GetRegE(const uint32_t data) {
  return FpuGetRegE_II(data);
}

uint32_t Mpyf64RdReRfMov32Mem32Ral::SetRegE(const uint8_t e) {
  return FpuSetRegE_II(opcode, e);
}

uint8_t Mpyf64RdReRfMov32Mem32Ral::GetRegF(const uint32_t data) {
  return FpuGetRegF_II(data);
}

uint32_t Mpyf64RdReRfMov32Mem32Ral::SetRegF(const uint8_t f) {
  return FpuSetRegF_II(opcode, f);
}

uint16_t Mpyf64RdReRfMov32Mem32Ral::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Mpyf64RdReRfMov32Mem32Ral::SetMem32(const uint16_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Addf64RdReRfMov32RalMem32
uint8_t Addf64RdReRfMov32RalMem32::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Addf64RdReRfMov32RalMem32::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Addf64RdReRfMov32RalMem32::GetRegD(const uint32_t data) {
  return FpuGetRegD_II(data);
}

uint32_t Addf64RdReRfMov32RalMem32::SetRegD(const uint8_t d) {
  return FpuSetRegD_II(opcode, d);
}

uint8_t Addf64RdReRfMov32RalMem32::GetRegE(const uint32_t data) {
  return FpuGetRegE_II(data);
}

uint32_t Addf64RdReRfMov32RalMem32::SetRegE(const uint8_t e) {
  return FpuSetRegE_II(opcode, e);
}

uint8_t Addf64RdReRfMov32RalMem32::GetRegF(const uint32_t data) {
  return FpuGetRegF_II(data);
}

uint32_t Addf64RdReRfMov32RalMem32::SetRegF(const uint8_t f) {
  return FpuSetRegF_II(opcode, f);
}

uint16_t Addf64RdReRfMov32RalMem32::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Addf64RdReRfMov32RalMem32::SetMem32(const uint16_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Addf64RdReRfMov32Mem32Ral
uint8_t Addf64RdReRfMov32Mem32Ral::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Addf64RdReRfMov32Mem32Ral::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Addf64RdReRfMov32Mem32Ral::GetRegD(const uint32_t data) {
  return FpuGetRegD_II(data);
}

uint32_t Addf64RdReRfMov32Mem32Ral::SetRegD(const uint8_t d) {
  return FpuSetRegD_II(opcode, d);
}

uint8_t Addf64RdReRfMov32Mem32Ral::GetRegE(const uint32_t data) {
  return FpuGetRegE_II(data);
}

uint32_t Addf64RdReRfMov32Mem32Ral::SetRegE(const uint8_t e) {
  return FpuSetRegE_II(opcode, e);
}

uint8_t Addf64RdReRfMov32Mem32Ral::GetRegF(const uint32_t data) {
  return FpuGetRegF_II(data);
}

uint32_t Addf64RdReRfMov32Mem32Ral::SetRegF(const uint8_t f) {
  return FpuSetRegF_II(opcode, f);
}

uint16_t Addf64RdReRfMov32Mem32Ral::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Addf64RdReRfMov32Mem32Ral::SetMem32(const uint16_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Subf64RdReRfMov32RalMem32
uint8_t Subf64RdReRfMov32RalMem32::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Subf64RdReRfMov32RalMem32::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Subf64RdReRfMov32RalMem32::GetRegD(const uint32_t data) {
  return FpuGetRegD_II(data);
}

uint32_t Subf64RdReRfMov32RalMem32::SetRegD(const uint8_t d) {
  return FpuSetRegD_II(opcode, d);
}

uint8_t Subf64RdReRfMov32RalMem32::GetRegE(const uint32_t data) {
  return FpuGetRegE_II(data);
}

uint32_t Subf64RdReRfMov32RalMem32::SetRegE(const uint8_t e) {
  return FpuSetRegE_II(opcode, e);
}

uint8_t Subf64RdReRfMov32RalMem32::GetRegF(const uint32_t data) {
  return FpuGetRegF_II(data);
}

uint32_t Subf64RdReRfMov32RalMem32::SetRegF(const uint8_t f) {
  return FpuSetRegF_II(opcode, f);
}

uint16_t Subf64RdReRfMov32RalMem32::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Subf64RdReRfMov32RalMem32::SetMem32(const uint16_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Subf64RdReRfMov32Mem32Ral
uint8_t Subf64RdReRfMov32Mem32Ral::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Subf64RdReRfMov32Mem32Ral::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Subf64RdReRfMov32Mem32Ral::GetRegD(const uint32_t data) {
  return FpuGetRegD_II(data);
}

uint32_t Subf64RdReRfMov32Mem32Ral::SetRegD(const uint8_t d) {
  return FpuSetRegD_II(opcode, d);
}

uint8_t Subf64RdReRfMov32Mem32Ral::GetRegE(const uint32_t data) {
  return FpuGetRegE_II(data);
}

uint32_t Subf64RdReRfMov32Mem32Ral::SetRegE(const uint8_t e) {
  return FpuSetRegE_II(opcode, e);
}

uint8_t Subf64RdReRfMov32Mem32Ral::GetRegF(const uint32_t data) {
  return FpuGetRegF_II(data);
}

uint32_t Subf64RdReRfMov32Mem32Ral::SetRegF(const uint8_t f) {
  return FpuSetRegF_II(opcode, f);
}

uint16_t Subf64RdReRfMov32Mem32Ral::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Subf64RdReRfMov32Mem32Ral::SetMem32(const uint16_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Macf64R3R2RdReRfMov32RalMem32
uint8_t Macf64R3R2RdReRfMov32RalMem32::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Macf64R3R2RdReRfMov32RalMem32::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Macf64R3R2RdReRfMov32RalMem32::GetRegD(const uint32_t data) {
  return FpuGetRegD_II(data);
}

uint32_t Macf64R3R2RdReRfMov32RalMem32::SetRegD(const uint8_t d) {
  return FpuSetRegD_II(opcode, d);
}

uint8_t Macf64R3R2RdReRfMov32RalMem32::GetRegE(const uint32_t data) {
  return FpuGetRegE_II(data);
}

uint32_t Macf64R3R2RdReRfMov32RalMem32::SetRegE(const uint8_t e) {
  return FpuSetRegE_II(opcode, e);
}

uint8_t Macf64R3R2RdReRfMov32RalMem32::GetRegF(const uint32_t data) {
  return FpuGetRegF_II(data);
}

uint32_t Macf64R3R2RdReRfMov32RalMem32::SetRegF(const uint8_t f) {
  return FpuSetRegF_II(opcode, f);
}

uint16_t Macf64R3R2RdReRfMov32RalMem32::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Macf64R3R2RdReRfMov32RalMem32::SetMem32(const uint16_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Macf64R7R6RdReRfMov32RalMem32
uint8_t Macf64R7R6RdReRfMov32RalMem32::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Macf64R7R6RdReRfMov32RalMem32::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Macf64R7R6RdReRfMov32RalMem32::GetRegD(const uint32_t data) {
  return FpuGetRegD_II(data);
}

uint32_t Macf64R7R6RdReRfMov32RalMem32::SetRegD(const uint8_t d) {
  return FpuSetRegD_II(opcode, d);
}

uint8_t Macf64R7R6RdReRfMov32RalMem32::GetRegE(const uint32_t data) {
  return FpuGetRegE_II(data);
}

uint32_t Macf64R7R6RdReRfMov32RalMem32::SetRegE(const uint8_t e) {
  return FpuSetRegE_II(opcode, e);
}

uint8_t Macf64R7R6RdReRfMov32RalMem32::GetRegF(const uint32_t data) {
  return FpuGetRegF_II(data);
}

uint32_t Macf64R7R6RdReRfMov32RalMem32::SetRegF(const uint8_t f) {
  return FpuSetRegF_II(opcode, f);
}

uint16_t Macf64R7R6RdReRfMov32RalMem32::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Macf64R7R6RdReRfMov32RalMem32::SetMem32(const uint16_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Mpyf64RdReRfMov32RahMem32
uint8_t Mpyf64RdReRfMov32RahMem32::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Mpyf64RdReRfMov32RahMem32::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Mpyf64RdReRfMov32RahMem32::GetRegD(const uint32_t data) {
  return FpuGetRegD_II(data);
}

uint32_t Mpyf64RdReRfMov32RahMem32::SetRegD(const uint8_t d) {
  return FpuSetRegD_II(opcode, d);
}

uint8_t Mpyf64RdReRfMov32RahMem32::GetRegE(const uint32_t data) {
  return FpuGetRegE_II(data);
}

uint32_t Mpyf64RdReRfMov32RahMem32::SetRegE(const uint8_t e) {
  return FpuSetRegE_II(opcode, e);
}

uint8_t Mpyf64RdReRfMov32RahMem32::GetRegF(const uint32_t data) {
  return FpuGetRegF_II(data);
}

uint32_t Mpyf64RdReRfMov32RahMem32::SetRegF(const uint8_t f) {
  return FpuSetRegF_II(opcode, f);
}

uint16_t Mpyf64RdReRfMov32RahMem32::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Mpyf64RdReRfMov32RahMem32::SetMem32(const uint16_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Mpyf64RdReRfMov32Mem32Rah
uint8_t Mpyf64RdReRfMov32Mem32Rah::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Mpyf64RdReRfMov32Mem32Rah::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Mpyf64RdReRfMov32Mem32Rah::GetRegD(const uint32_t data) {
  return FpuGetRegD_II(data);
}

uint32_t Mpyf64RdReRfMov32Mem32Rah::SetRegD(const uint8_t d) {
  return FpuSetRegD_II(opcode, d);
}

uint8_t Mpyf64RdReRfMov32Mem32Rah::GetRegE(const uint32_t data) {
  return FpuGetRegE_II(data);
}

uint32_t Mpyf64RdReRfMov32Mem32Rah::SetRegE(const uint8_t e) {
  return FpuSetRegE_II(opcode, e);
}

uint8_t Mpyf64RdReRfMov32Mem32Rah::GetRegF(const uint32_t data) {
  return FpuGetRegF_II(data);
}

uint32_t Mpyf64RdReRfMov32Mem32Rah::SetRegF(const uint8_t f) {
  return FpuSetRegF_II(opcode, f);
}

uint16_t Mpyf64RdReRfMov32Mem32Rah::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Mpyf64RdReRfMov32Mem32Rah::SetMem32(const uint16_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Addf64RdReRfMov32RahMem32
uint8_t Addf64RdReRfMov32RahMem32::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Addf64RdReRfMov32RahMem32::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Addf64RdReRfMov32RahMem32::GetRegD(const uint32_t data) {
  return FpuGetRegD_II(data);
}

uint32_t Addf64RdReRfMov32RahMem32::SetRegD(const uint8_t d) {
  return FpuSetRegD_II(opcode, d);
}

uint8_t Addf64RdReRfMov32RahMem32::GetRegE(const uint32_t data) {
  return FpuGetRegE_II(data);
}

uint32_t Addf64RdReRfMov32RahMem32::SetRegE(const uint8_t e) {
  return FpuSetRegE_II(opcode, e);
}

uint8_t Addf64RdReRfMov32RahMem32::GetRegF(const uint32_t data) {
  return FpuGetRegF_II(data);
}

uint32_t Addf64RdReRfMov32RahMem32::SetRegF(const uint8_t f) {
  return FpuSetRegF_II(opcode, f);
}

uint16_t Addf64RdReRfMov32RahMem32::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Addf64RdReRfMov32RahMem32::SetMem32(const uint16_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Addf64RdReRfMov32Mem32Rah
uint8_t Addf64RdReRfMov32Mem32Rah::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Addf64RdReRfMov32Mem32Rah::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Addf64RdReRfMov32Mem32Rah::GetRegD(const uint32_t data) {
  return FpuGetRegD_II(data);
}

uint32_t Addf64RdReRfMov32Mem32Rah::SetRegD(const uint8_t d) {
  return FpuSetRegD_II(opcode, d);
}

uint8_t Addf64RdReRfMov32Mem32Rah::GetRegE(const uint32_t data) {
  return FpuGetRegE_II(data);
}

uint32_t Addf64RdReRfMov32Mem32Rah::SetRegE(const uint8_t e) {
  return FpuSetRegE_II(opcode, e);
}

uint8_t Addf64RdReRfMov32Mem32Rah::GetRegF(const uint32_t data) {
  return FpuGetRegF_II(data);
}

uint32_t Addf64RdReRfMov32Mem32Rah::SetRegF(const uint8_t f) {
  return FpuSetRegF_II(opcode, f);
}

uint16_t Addf64RdReRfMov32Mem32Rah::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Addf64RdReRfMov32Mem32Rah::SetMem32(const uint16_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Subf64RdReRfMov32RahMem32
uint8_t Subf64RdReRfMov32RahMem32::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Subf64RdReRfMov32RahMem32::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Subf64RdReRfMov32RahMem32::GetRegD(const uint32_t data) {
  return FpuGetRegD_II(data);
}

uint32_t Subf64RdReRfMov32RahMem32::SetRegD(const uint8_t d) {
  return FpuSetRegD_II(opcode, d);
}

uint8_t Subf64RdReRfMov32RahMem32::GetRegE(const uint32_t data) {
  return FpuGetRegE_II(data);
}

uint32_t Subf64RdReRfMov32RahMem32::SetRegE(const uint8_t e) {
  return FpuSetRegE_II(opcode, e);
}

uint8_t Subf64RdReRfMov32RahMem32::GetRegF(const uint32_t data) {
  return FpuGetRegF_II(data);
}

uint32_t Subf64RdReRfMov32RahMem32::SetRegF(const uint8_t f) {
  return FpuSetRegF_II(opcode, f);
}

uint16_t Subf64RdReRfMov32RahMem32::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Subf64RdReRfMov32RahMem32::SetMem32(const uint16_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Subf64RdReRfMov32Mem32Rah
uint8_t Subf64RdReRfMov32Mem32Rah::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Subf64RdReRfMov32Mem32Rah::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Subf64RdReRfMov32Mem32Rah::GetRegD(const uint32_t data) {
  return FpuGetRegD_II(data);
}

uint32_t Subf64RdReRfMov32Mem32Rah::SetRegD(const uint8_t d) {
  return FpuSetRegD_II(opcode, d);
}

uint8_t Subf64RdReRfMov32Mem32Rah::GetRegE(const uint32_t data) {
  return FpuGetRegE_II(data);
}

uint32_t Subf64RdReRfMov32Mem32Rah::SetRegE(const uint8_t e) {
  return FpuSetRegE_II(opcode, e);
}

uint8_t Subf64RdReRfMov32Mem32Rah::GetRegF(const uint32_t data) {
  return FpuGetRegF_II(data);
}

uint32_t Subf64RdReRfMov32Mem32Rah::SetRegF(const uint8_t f) {
  return FpuSetRegF_II(opcode, f);
}

uint16_t Subf64RdReRfMov32Mem32Rah::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Subf64RdReRfMov32Mem32Rah::SetMem32(const uint16_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Macf64R3R2RdReRfMov32RahMem32
uint8_t Macf64R3R2RdReRfMov32RahMem32::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Macf64R3R2RdReRfMov32RahMem32::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Macf64R3R2RdReRfMov32RahMem32::GetRegD(const uint32_t data) {
  return FpuGetRegD_II(data);
}

uint32_t Macf64R3R2RdReRfMov32RahMem32::SetRegD(const uint8_t d) {
  return FpuSetRegD_II(opcode, d);
}

uint8_t Macf64R3R2RdReRfMov32RahMem32::GetRegE(const uint32_t data) {
  return FpuGetRegE_II(data);
}

uint32_t Macf64R3R2RdReRfMov32RahMem32::SetRegE(const uint8_t e) {
  return FpuSetRegE_II(opcode, e);
}

uint8_t Macf64R3R2RdReRfMov32RahMem32::GetRegF(const uint32_t data) {
  return FpuGetRegF_II(data);
}

uint32_t Macf64R3R2RdReRfMov32RahMem32::SetRegF(const uint8_t f) {
  return FpuSetRegF_II(opcode, f);
}

uint16_t Macf64R3R2RdReRfMov32RahMem32::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Macf64R3R2RdReRfMov32RahMem32::SetMem32(const uint16_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Macf64R7R6RdReRfMov32RahMem32
uint8_t Macf64R7R6RdReRfMov32RahMem32::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Macf64R7R6RdReRfMov32RahMem32::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Macf64R7R6RdReRfMov32RahMem32::GetRegD(const uint32_t data) {
  return FpuGetRegD_II(data);
}

uint32_t Macf64R7R6RdReRfMov32RahMem32::SetRegD(const uint8_t d) {
  return FpuSetRegD_II(opcode, d);
}

uint8_t Macf64R7R6RdReRfMov32RahMem32::GetRegE(const uint32_t data) {
  return FpuGetRegE_II(data);
}

uint32_t Macf64R7R6RdReRfMov32RahMem32::SetRegE(const uint8_t e) {
  return FpuSetRegE_II(opcode, e);
}

uint8_t Macf64R7R6RdReRfMov32RahMem32::GetRegF(const uint32_t data) {
  return FpuGetRegF_II(data);
}

uint32_t Macf64R7R6RdReRfMov32RahMem32::SetRegF(const uint8_t f) {
  return FpuSetRegF_II(opcode, f);
}

uint16_t Macf64R7R6RdReRfMov32RahMem32::GetMem32(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Macf64R7R6RdReRfMov32RahMem32::SetMem32(const uint16_t mem32) {
  return FpuSetMem(opcode, mem32);
}

// Mpyf64RaRbRcAddf64RdReRf
// Uses Format I for Ra, Rb, Rc and Format IV for Rd, Re, Rf
uint8_t Mpyf64RaRbRcAddf64RdReRf::GetRegA(const uint32_t data) {
  return FpuGetRegA_I(data);
}

uint32_t Mpyf64RaRbRcAddf64RdReRf::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t Mpyf64RaRbRcAddf64RdReRf::GetRegB(const uint32_t data) {
  return FpuGetRegB_I(data);
}

uint32_t Mpyf64RaRbRcAddf64RdReRf::SetRegB(const uint8_t b) {
  return FpuSetRegB_I(opcode, b);
}

uint8_t Mpyf64RaRbRcAddf64RdReRf::GetRegC(const uint32_t data) {
  return FpuGetRegC_I(data);
}

uint32_t Mpyf64RaRbRcAddf64RdReRf::SetRegC(const uint8_t c) {
  return FpuSetRegC_I(opcode, c);
}

uint8_t Mpyf64RaRbRcAddf64RdReRf::GetRegD(const uint32_t data) {
  return FpuGetRegD_IV(data);
}

uint32_t Mpyf64RaRbRcAddf64RdReRf::SetRegD(const uint8_t d) {
  return FpuSetRegD_IV(opcode, d);
}

uint8_t Mpyf64RaRbRcAddf64RdReRf::GetRegE(const uint32_t data) {
  return FpuGetRegE_IV(data);
}

uint32_t Mpyf64RaRbRcAddf64RdReRf::SetRegE(const uint8_t e) {
  return FpuSetRegE_IV(opcode, e);
}

uint8_t Mpyf64RaRbRcAddf64RdReRf::GetRegF(const uint32_t data) {
  return FpuGetRegF_IV(data);
}

uint32_t Mpyf64RaRbRcAddf64RdReRf::SetRegF(const uint8_t f) {
  return FpuSetRegF_IV(opcode, f);
}

// Mpyf64RaRbRcSubf64RdReRf - same encoding as Mpyf64RaRbRcAddf64RdReRf
uint8_t Mpyf64RaRbRcSubf64RdReRf::GetRegA(const uint32_t data) {
  return FpuGetRegA_I(data);
}

uint32_t Mpyf64RaRbRcSubf64RdReRf::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t Mpyf64RaRbRcSubf64RdReRf::GetRegB(const uint32_t data) {
  return FpuGetRegB_I(data);
}

uint32_t Mpyf64RaRbRcSubf64RdReRf::SetRegB(const uint8_t b) {
  return FpuSetRegB_I(opcode, b);
}

uint8_t Mpyf64RaRbRcSubf64RdReRf::GetRegC(const uint32_t data) {
  return FpuGetRegC_I(data);
}

uint32_t Mpyf64RaRbRcSubf64RdReRf::SetRegC(const uint8_t c) {
  return FpuSetRegC_I(opcode, c);
}

uint8_t Mpyf64RaRbRcSubf64RdReRf::GetRegD(const uint32_t data) {
  return FpuGetRegD_IV(data);
}

uint32_t Mpyf64RaRbRcSubf64RdReRf::SetRegD(const uint8_t d) {
  return FpuSetRegD_IV(opcode, d);
}

uint8_t Mpyf64RaRbRcSubf64RdReRf::GetRegE(const uint32_t data) {
  return FpuGetRegE_IV(data);
}

uint32_t Mpyf64RaRbRcSubf64RdReRf::SetRegE(const uint8_t e) {
  return FpuSetRegE_IV(opcode, e);
}

uint8_t Mpyf64RaRbRcSubf64RdReRf::GetRegF(const uint32_t data) {
  return FpuGetRegF_IV(data);
}

uint32_t Mpyf64RaRbRcSubf64RdReRf::SetRegF(const uint8_t f) {
  return FpuSetRegF_IV(opcode, f);
}

// Mpyf64RaRbRc - Format I for Ra, Rb, Rc
uint8_t Mpyf64RaRbRc::GetRegA(const uint32_t data) {
  return FpuGetRegA_I(data);
}

uint32_t Mpyf64RaRbRc::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t Mpyf64RaRbRc::GetRegB(const uint32_t data) {
  return FpuGetRegB_I(data);
}

uint32_t Mpyf64RaRbRc::SetRegB(const uint8_t b) {
  return FpuSetRegB_I(opcode, b);
}

uint8_t Mpyf64RaRbRc::GetRegC(const uint32_t data) {
  return FpuGetRegC_I(data);
}

uint32_t Mpyf64RaRbRc::SetRegC(const uint8_t c) {
  return FpuSetRegC_I(opcode, c);
}

// Addf64RaRbRc - Format I for Ra, Rb, Rc
uint8_t Addf64RaRbRc::GetRegA(const uint32_t data) {
  return FpuGetRegA_I(data);
}

uint32_t Addf64RaRbRc::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t Addf64RaRbRc::GetRegB(const uint32_t data) {
  return FpuGetRegB_I(data);
}

uint32_t Addf64RaRbRc::SetRegB(const uint8_t b) {
  return FpuSetRegB_I(opcode, b);
}

uint8_t Addf64RaRbRc::GetRegC(const uint32_t data) {
  return FpuGetRegC_I(data);
}

uint32_t Addf64RaRbRc::SetRegC(const uint8_t c) {
  return FpuSetRegC_I(opcode, c);
}

// Subf64RaRbRc - Format I for Ra, Rb, Rc
uint8_t Subf64RaRbRc::GetRegA(const uint32_t data) {
  return FpuGetRegA_I(data);
}

uint32_t Subf64RaRbRc::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t Subf64RaRbRc::GetRegB(const uint32_t data) {
  return FpuGetRegB_I(data);
}

uint32_t Subf64RaRbRc::SetRegB(const uint8_t b) {
  return FpuSetRegB_I(opcode, b);
}

uint8_t Subf64RaRbRc::GetRegC(const uint32_t data) {
  return FpuGetRegC_I(data);
}

uint32_t Subf64RaRbRc::SetRegC(const uint8_t c) {
  return FpuSetRegC_I(opcode, c);
}

// Mpyf64RaRb16F - Format I for Ra, Rb, with 16-bit immediate
uint8_t Mpyf64RaRb16F::GetRegA(const uint32_t data) {
  return FpuGetRegA_I(data);
}

uint32_t Mpyf64RaRb16F::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t Mpyf64RaRb16F::GetRegB(const uint32_t data) {
  return FpuGetRegB_I(data);
}

uint32_t Mpyf64RaRb16F::SetRegB(const uint8_t b) {
  return FpuSetRegB_I(opcode, b);
}

uint16_t Mpyf64RaRb16F::Get16F(const uint32_t data) {
  return FpuGet16FHi_I(data);
}

uint32_t Mpyf64RaRb16F::Set16F(const uint16_t imm) {
  return FpuSet16FHi_I(opcode, imm);
}

// Addf64RaRb16F - Format I for Ra, Rb, with 16-bit immediate
uint8_t Addf64RaRb16F::GetRegA(const uint32_t data) {
  return FpuGetRegA_I(data);
}

uint32_t Addf64RaRb16F::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t Addf64RaRb16F::GetRegB(const uint32_t data) {
  return FpuGetRegB_I(data);
}

uint32_t Addf64RaRb16F::SetRegB(const uint8_t b) {
  return FpuSetRegB_I(opcode, b);
}

uint16_t Addf64RaRb16F::Get16F(const uint32_t data) {
  return FpuGet16FHi_I(data);
}

uint32_t Addf64RaRb16F::Set16F(const uint16_t imm) {
  return FpuSet16FHi_I(opcode, imm);
}

// Subf64Ra16FRb - Format I for Ra, Rb, with 16-bit immediate
uint8_t Subf64Ra16FRb::GetRegA(const uint32_t data) {
  return FpuGetRegA_I(data);
}

uint32_t Subf64Ra16FRb::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t Subf64Ra16FRb::GetRegB(const uint32_t data) {
  return FpuGetRegB_I(data);
}

uint32_t Subf64Ra16FRb::SetRegB(const uint8_t b) {
  return FpuSetRegB_I(opcode, b);
}

uint16_t Subf64Ra16FRb::Get16F(const uint32_t data) {
  return FpuGet16FHi_I(data);
}

uint32_t Subf64Ra16FRb::Set16F(const uint16_t imm) {
  return FpuSet16FHi_I(opcode, imm);
}

// Cmpf64RaRb - Format I for Ra, Rb only
uint8_t Cmpf64RaRb::GetRegA(const uint32_t data) { return FpuGetRegA_I(data); }

uint32_t Cmpf64RaRb::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t Cmpf64RaRb::GetRegB(const uint32_t data) { return FpuGetRegB_I(data); }

uint32_t Cmpf64RaRb::SetRegB(const uint8_t b) {
  return FpuSetRegB_I(opcode, b);
}

// Cmpf64Ra16F - Format III for Ra with 16-bit immediate
uint8_t Cmpf64Ra16F::GetRegA(const uint32_t data) {
  return FpuGetRegA_III(data);
}

uint32_t Cmpf64Ra16F::SetRegA(const uint8_t a) {
  return FpuSetRegA_III(opcode, a);
}

uint16_t Cmpf64Ra16F::Get16F(const uint32_t data) {
  return FpuGet16FHi_III(data);
}

uint32_t Cmpf64Ra16F::Set16F(const uint16_t imm) {
  return FpuSet16FHi_III(opcode, imm);
}

// Cmpf64Ra0 - 2-byte instruction, Ra in bits 2-0
uint8_t Cmpf64Ra0::GetRegA(const uint32_t data) { return data & 0x7u; }

uint32_t Cmpf64Ra0::SetRegA(const uint8_t a) { return opcode | (a & 0x7u); }

// Maxf64RaRb - Format I for Ra, Rb only
uint8_t Maxf64RaRb::GetRegA(const uint32_t data) { return FpuGetRegA_I(data); }

uint32_t Maxf64RaRb::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t Maxf64RaRb::GetRegB(const uint32_t data) { return FpuGetRegB_I(data); }

uint32_t Maxf64RaRb::SetRegB(const uint8_t b) {
  return FpuSetRegB_I(opcode, b);
}

// Maxf64RaRbMov64RcRd - Format I for Ra, Rb, Rc and Format IV for Rd
uint8_t Maxf64RaRbMov64RcRd::GetRegA(const uint32_t data) {
  return FpuGetRegA_I(data);
}

uint32_t Maxf64RaRbMov64RcRd::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t Maxf64RaRbMov64RcRd::GetRegB(const uint32_t data) {
  return FpuGetRegB_I(data);
}

uint32_t Maxf64RaRbMov64RcRd::SetRegB(const uint8_t b) {
  return FpuSetRegB_I(opcode, b);
}

uint8_t Maxf64RaRbMov64RcRd::GetRegC(const uint32_t data) {
  return FpuGetRegC_I(data);
}

uint32_t Maxf64RaRbMov64RcRd::SetRegC(const uint8_t c) {
  return FpuSetRegC_I(opcode, c);
}

uint8_t Maxf64RaRbMov64RcRd::GetRegD(const uint32_t data) {
  return FpuGetRegD_IV(data);
}

uint32_t Maxf64RaRbMov64RcRd::SetRegD(const uint8_t d) {
  return FpuSetRegD_IV(opcode, d);
}

// Maxf64Ra16F - Format III for Ra with 16-bit immediate
uint8_t Maxf64Ra16F::GetRegA(const uint32_t data) {
  return FpuGetRegA_III(data);
}

uint32_t Maxf64Ra16F::SetRegA(const uint8_t a) {
  return FpuSetRegA_III(opcode, a);
}

uint16_t Maxf64Ra16F::Get16F(const uint32_t data) {
  return FpuGet16FHi_III(data);
}

uint32_t Maxf64Ra16F::Set16F(const uint16_t imm) {
  return FpuSet16FHi_III(opcode, imm);
}

// Minf64RaRb - Format I for Ra, Rb only
uint8_t Minf64RaRb::GetRegA(const uint32_t data) { return FpuGetRegA_I(data); }

uint32_t Minf64RaRb::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t Minf64RaRb::GetRegB(const uint32_t data) { return FpuGetRegB_I(data); }

uint32_t Minf64RaRb::SetRegB(const uint8_t b) {
  return FpuSetRegB_I(opcode, b);
}

// Minf64RaRbMov64RcRd - Format I for Ra, Rb, Rc and Format IV for Rd
uint8_t Minf64RaRbMov64RcRd::GetRegA(const uint32_t data) {
  return FpuGetRegA_I(data);
}

uint32_t Minf64RaRbMov64RcRd::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t Minf64RaRbMov64RcRd::GetRegB(const uint32_t data) {
  return FpuGetRegB_I(data);
}

uint32_t Minf64RaRbMov64RcRd::SetRegB(const uint8_t b) {
  return FpuSetRegB_I(opcode, b);
}

uint8_t Minf64RaRbMov64RcRd::GetRegC(const uint32_t data) {
  return FpuGetRegC_I(data);
}

uint32_t Minf64RaRbMov64RcRd::SetRegC(const uint8_t c) {
  return FpuSetRegC_I(opcode, c);
}

uint8_t Minf64RaRbMov64RcRd::GetRegD(const uint32_t data) {
  return FpuGetRegD_IV(data);
}

uint32_t Minf64RaRbMov64RcRd::SetRegD(const uint8_t d) {
  return FpuSetRegD_IV(opcode, d);
}

// Minf64Ra16F - Format III for Ra with 16-bit immediate
uint8_t Minf64Ra16F::GetRegA(const uint32_t data) {
  return FpuGetRegA_III(data);
}

uint32_t Minf64Ra16F::SetRegA(const uint8_t a) {
  return FpuSetRegA_III(opcode, a);
}

uint16_t Minf64Ra16F::Get16F(const uint32_t data) {
  return FpuGet16FHi_III(data);
}

uint32_t Minf64Ra16F::Set16F(const uint16_t imm) {
  return FpuSet16FHi_III(opcode, imm);
}

// F64toi32RahRb - Format I for RaH, Rb
uint8_t F64toi32RahRb::GetRegA(const uint32_t data) {
  return FpuGetRegA_I(data);
}

uint32_t F64toi32RahRb::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t F64toi32RahRb::GetRegB(const uint32_t data) {
  return FpuGetRegB_I(data);
}

uint32_t F64toi32RahRb::SetRegB(const uint8_t b) {
  return FpuSetRegB_I(opcode, b);
}

// F64toui32RahRb - Format I for RaH, Rb
uint8_t F64toui32RahRb::GetRegA(const uint32_t data) {
  return FpuGetRegA_I(data);
}

uint32_t F64toui32RahRb::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t F64toui32RahRb::GetRegB(const uint32_t data) {
  return FpuGetRegB_I(data);
}

uint32_t F64toui32RahRb::SetRegB(const uint8_t b) {
  return FpuSetRegB_I(opcode, b);
}

// I32tof64RaMem32 - Format II for Ra (bits 10-8), mem32 (bits 7-0)
uint8_t I32tof64RaMem32::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t I32tof64RaMem32::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t I32tof64RaMem32::GetMem(const uint32_t data) { return FpuGetMem(data); }

uint32_t I32tof64RaMem32::SetMem(const uint8_t mem) {
  return FpuSetMem(opcode, mem);
}

// I32tof64RaRbh - Format I for Ra, RbH
uint8_t I32tof64RaRbh::GetRegA(const uint32_t data) {
  return FpuGetRegA_I(data);
}

uint32_t I32tof64RaRbh::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t I32tof64RaRbh::GetRegB(const uint32_t data) {
  return FpuGetRegB_I(data);
}

uint32_t I32tof64RaRbh::SetRegB(const uint8_t b) {
  return FpuSetRegB_I(opcode, b);
}

// Ui32tof64RaMem32 - Format II for Ra (bits 10-8), mem32 (bits 7-0)
uint8_t Ui32tof64RaMem32::GetRegA(const uint32_t data) {
  return FpuGetRegA_II(data);
}

uint32_t Ui32tof64RaMem32::SetRegA(const uint8_t a) {
  return FpuSetRegA_II(opcode, a);
}

uint8_t Ui32tof64RaMem32::GetMem(const uint32_t data) {
  return FpuGetMem(data);
}

uint32_t Ui32tof64RaMem32::SetMem(const uint8_t mem) {
  return FpuSetMem(opcode, mem);
}

// F64toui64RaRb - Format I for Ra, Rb
uint8_t F64toui64RaRb::GetRegA(const uint32_t data) {
  return FpuGetRegA_I(data);
}

uint32_t F64toui64RaRb::SetRegA(const uint8_t a) {
  return FpuSetRegA_I(opcode, a);
}

uint8_t F64toui64RaRb::GetRegB(const uint32_t data) {
  return FpuGetRegB_I(data);
}
...
// Vlshl32Vra5bit - 5-bit immediate at bits 7-3, 3-bit VRa at bits 2-0
uint8_t Vlshl32Vra5bit::GetRegA(const uint32_t data) {
  return VcuGetRegA_III(data);
}

uint32_t Vlshl32Vra5bit::SetRegA(const uint8_t a) {
  return VcuSetRegA_III(opcode, a);
}

uint8_t Vlshl32Vra5bit::GetImm5(const uint32_t data) {
  return VcuGetImm5_III(data);
}

uint32_t Vlshl32Vra5bit::SetImm5(const uint8_t imm) {
  return VcuSetImm5_III(opcode, imm);
}

// Vlshr32Vra5bit - 5-bit immediate at bits 7-3, 3-bit VRa at bits 2-0
uint8_t Vlshr32Vra5bit::GetRegA(const uint32_t data) {
  return VcuGetRegA_III(data);
}

uint32_t Vlshr32Vra5bit::SetRegA(const uint8_t a) {
  return VcuSetRegA_III(opcode, a);
}

uint8_t Vlshr32Vra5bit::GetImm5(const uint32_t data) {
  return VcuGetImm5_III(data);
}
...
// VccmacVr5Vr4Vr3Vr2Vr1Vr0Vmov32VraMem32 - RegA at bits 11-8, mem32 at bits
// 7-0
// Encoding:
//   LSW: 1110 0011 1111 0111 = 0xE3F7 (bits [31:16])
//   MSW: 0001 aaaa mmmm mmmm (bits [15:0])
uint8_t VccmacVr5Vr4Vr3Vr2Vr1Vr0Vmov32VraMem32::GetRegA(const uint32_t data) {
  return VcuGetRegA_II(data);
}

uint32_t VccmacVr5Vr4Vr3Vr2Vr1Vr0Vmov32VraMem32::SetRegA(const uint8_t a) {
  return VcuSetRegA_II(opcode, a);
}

uint8_t VccmacVr5Vr4Vr3Vr2Vr1Vr0Vmov32VraMem32::GetMem32(const uint32_t data) {
  return VcuGetMem(data);
}

uint32_t VccmacVr5Vr4Vr3Vr2Vr1Vr0Vmov32VraMem32::SetMem32(const uint8_t mem) {
  return VcuSetMem(opcode, mem);
}

// VccmacVr7Vr6Vr5Vr4Mem32Xar7Postinc - mem32 at bits 7-0
// Encoding:
//   LSW: 1110 0010 0101 0001 = 0xE251 (bits [31:16])
//   MSW: 0010 1111 mmmm mmmm (bits [15:0])
uint8_t VccmacVr7Vr6Vr5Vr4Mem32Xar7Postinc::GetMem32(const uint32_t data) {
  return VcuGetMem(data);
}
...
// VccmpyVr3Vr2Vr1Vr0Vmov32VraMem32Load - RegA at bits 11-8, mem32 at bits 7-0
// Encoding:
//   LSW: 1110 0011 1111 0110 = 0xE3F6 (bits [31:16])
//   MSW: 0001 aaaa mmmm mmmm (bits [15:0])
uint8_t VccmpyVr3Vr2Vr1Vr0Vmov32VraMem32Load::GetRegA(const uint32_t data) {
  return VcuGetRegA_II(data);
}

uint32_t VccmpyVr3Vr2Vr1Vr0Vmov32VraMem32Load::SetRegA(const uint8_t a) {
  return VcuSetRegA_II(opcode, a);
}

uint8_t VccmpyVr3Vr2Vr1Vr0Vmov32VraMem32Load::GetMem32(const uint32_t data) {
  return VcuGetMem(data);
}

uint32_t VccmpyVr3Vr2Vr1Vr0Vmov32VraMem32Load::SetMem32(const uint8_t mem) {
  return VcuSetMem(opcode, mem);
}

// VcconVra - 4-bit VRa at bits 3-0 (2-byte instruction)
// Encoding: 1110 0001 0001 aaaa (LSW only)
uint8_t VcconVra::GetRegA(const uint16_t data) { return VcuGetRegA_IV(data); }

uint16_t VcconVra::SetRegA(const uint8_t a) { return VcuSetRegA_IV(opcode, a); }

// Vcdadd16Vr5Vr4Vr3Vr2Vmov32VraMem32 - RegA at bits 11-8, mem32 at bits 7-0
// Encoding:
//   LSW: 1110 0011 1111 1010 = 0xE3FA (bits [31:16])
//   MSW: 0000 aaaa mmmm mmmm (bits [15:0])
uint8_t Vcdadd16Vr5Vr4Vr3Vr2Vmov32VraMem32::GetRegA(const uint32_t data) {
  return VcuGetRegA_II(data);
}

uint32_t Vcdadd16Vr5Vr4Vr3Vr2Vmov32VraMem32::SetRegA(const uint8_t a) {
  return VcuSetRegA_II(opcode, a);
}

uint8_t Vcdadd16Vr5Vr4Vr3Vr2Vmov32VraMem32::GetMem32(const uint32_t data) {
  return VcuGetMem(data);
}

uint32_t Vcdadd16Vr5Vr4Vr3Vr2Vmov32VraMem32::SetMem32(const uint8_t mem) {
  return VcuSetMem(opcode, mem);
}

// Vcdsub16Vr6Vr4Vr3Vr2Vmov32VraMem32 - RegA at bits 11-8, mem32 at bits 7-0
// Encoding:
//   LSW: 1110 0011 1111 1011 = 0xE3FB (bits [31:16])
//   MSW: 0000 aaaa mmmm mmmm (bits [15:0])
uint8_t Vcdsub16Vr6Vr4Vr3Vr2Vmov32VraMem32::GetRegA(const uint32_t data) {
  return VcuGetRegA_II(data);
}

uint32_t Vcdsub16Vr6Vr4Vr3Vr2Vmov32VraMem32::SetRegA(const uint8_t a) {
  return VcuSetRegA_II(opcode, a);
}

uint8_t Vcdsub16Vr6Vr4Vr3Vr2Vmov32VraMem32::GetMem32(const uint32_t data) {
  return VcuGetMem(data);
}

uint32_t Vcdsub16Vr6Vr4Vr3Vr2Vmov32VraMem32::SetMem32(const uint8_t mem) {
  return VcuSetMem(opcode, mem);
}

// VcflipVra - 4-bit VRa at bits 3-0 (2-byte instruction)
// Encoding: 1010 0001 0000 aaaa (LSW only)
uint8_t VcflipVra::GetRegA(const uint16_t data) { return VcuGetRegA_IV(data); }
...
// VcmacVr5Vr4Vr3Vr2Vr1Vr0Vmov32VraMem32 - RegA at bits 11-8, mem32 at bits
// 7-0
// Encoding:
//   LSW: 1110 0011 1111 0111 = 0xE3F7 (bits [31:16])
//   MSW: 0000 aaaa mmmm mmmm (bits [15:0])
uint8_t VcmacVr5Vr4Vr3Vr2Vr1Vr0Vmov32VraMem32::GetRegA(const uint32_t data) {
  return VcuGetRegA_II(data);
}

uint32_t VcmacVr5Vr4Vr3Vr2Vr1Vr0Vmov32VraMem32::SetRegA(const uint8_t a) {
  return VcuSetRegA_II(opcode, a);
}

uint8_t VcmacVr5Vr4Vr3Vr2Vr1Vr0Vmov32VraMem32::GetMem32(const uint32_t data) {
  return VcuGetMem(data);
}

uint32_t VcmacVr5Vr4Vr3Vr2Vr1Vr0Vmov32VraMem32::SetMem32(const uint8_t mem) {
  return VcuSetMem(opcode, mem);
}

// VcmagVrbVra - RegA at bits 3-0, RegB at bits 7-4
// Encoding:
//   LSW: 1110 0110 1111 0010 = 0xE6F2 (bits [31:16])
//   MSW: 0000 0100 bbbb aaaa (bits [15:0])
uint8_t VcmagVrbVra::GetRegA(const uint32_t data) { return VcuGetRegA_I(data); }

uint32_t VcmagVrbVra::SetRegA(const uint8_t a) {
  return VcuSetRegA_I(opcode, a);
}

uint8_t VcmagVrbVra::GetRegB(const uint32_t data) { return VcuGetRegB_I(data); }

uint32_t VcmagVrbVra::SetRegB(const uint8_t b) {
  return VcuSetRegB_I(opcode, b);
}

// VcmpyVr3Vr2Vr1Vr0Vmov32Mem32Vra - RegA at bits 11-8, mem32 at bits 7-0
// Encoding:
//   LSW: 1110 0010 1100 1010 = 0xE2CA (bits [31:16])
//   MSW: 0000 aaaa mmmm mmmm (bits [15:0])
uint8_t VcmpyVr3Vr2Vr1Vr0Vmov32Mem32Vra::GetRegA(const uint32_t data) {
  return VcuGetRegA_II(data);
}

uint32_t VcmpyVr3Vr2Vr1Vr0Vmov32Mem32Vra::SetRegA(const uint8_t a) {
  return VcuSetRegA_II(opcode, a);
}

uint8_t VcmpyVr3Vr2Vr1Vr0Vmov32Mem32Vra::GetMem32(const uint32_t data) {
  return VcuGetMem(data);
}

uint32_t VcmpyVr3Vr2Vr1Vr0Vmov32Mem32Vra::SetMem32(const uint8_t mem) {
  return VcuSetMem(opcode, mem);
}
...
// Vcshl16Vra4bit - RegA at bits 3-0, 4-bit immediate at bits 7-4
// Encoding:
//   LSW: 1110 0110 1111 0010 = 0xE6F2 (bits [31:16])
//   MSW: 0000 0000 IIII aaaa (bits [15:0])
uint8_t Vcshl16Vra4bit::GetRegA(const uint32_t data) {
  return VcuGetRegA_I(data);
}

uint32_t Vcshl16Vra4bit::SetRegA(const uint8_t a) {
  return VcuSetRegA_I(opcode, a);
}

uint8_t Vcshl16Vra4bit::GetImm4(const uint32_t data) {
  return VcuGetRegB_I(data);
}

uint32_t Vcshl16Vra4bit::SetImm4(const uint8_t imm) {
  return VcuSetRegB_I(opcode, imm);
}
