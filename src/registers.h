...
inline std::unordered_map<uint8_t, std::string> NAMES = {
    {ACC, "acc"},   {AH, "ah"},     {AL, "al"},
    {XAR0, "xar0"}, {XAR1, "xar1"}, {XAR2, "xar2"},
    {XAR3, "xar3"}, {XAR4, "xar4"}, {XAR5, "xar5"},
    {XAR6, "xar6"}, {XAR7, "xar7"}, {AR0, "ar0"},
    {AR1, "ar1"},   {AR2, "ar2"},   {AR3, "ar3"},
    {AR4, "ar4"},   {AR5, "ar5"},   {AR6, "ar6"},
    {AR7, "ar7"},   {AR0H, "ar0h"}, {AR1H, "ar1h"},
    {AR2H, "ar2h"}, {AR3H, "ar3h"}, {AR4H, "ar4h"},
    {AR5H, "ar5h"}, {AR6H, "ar6h"}, {AR7H, "ar7h"},
    {BR0, "br0"},   {BR1, "br1"},   {BR2, "br2"},
    {BR3, "br3"},   {BR4, "br4"},   {BR5, "br5"},
    {BR6, "br6"},   {BR7, "br7"},   {DP, "dp"},
    {IFR, "ifr"},   {IER, "ier"},   {DBGIER, "dbgier"},
    {P, "p"},       {PH, "ph"},     {PL, "pl"},
    {PC, "pc"},     {RPC, "rpc"},   {SP, "sp"},
    {ST0, "st0"},   {ST1, "st1"},   {XT, "xt"},
    {T, "t"},       {TL, "tl"},     {TH, "th"},
    {R0H, "r0h"},   {R1H, "r1h"},   {R2H, "r2h"},
    {R3H, "r3h"},   {R4H, "r4h"},   {R5H, "r5h"},
    {R6H, "r6h"},   {R7H, "r7h"},   {R0L, "r0l"},
    {R1L, "r1l"},   {R2L, "r2l"},   {R3L, "r3l"},
    {R4L, "r4l"},   {R5L, "r5l"},   {R6L, "r6l"},
    {R7L, "r7l"},   {STF, "stf"},   {RB, "rb"},
    {VR0, "vr0"},   {VR1, "vr1"},   {VR2, "vr2"},
    {VR3, "vr3"},   {VR4, "vr4"},   {VR5, "vr5"},
    {VR6, "vr6"},   {VR7, "vr7"},   {VR8, "vr8"},
    {VT0, "vt0"},   {VT1, "vt1"},   {VSTATUS, "vstatus"},
};
...
inline std::unordered_map<uint8_t, RegInfo> INFO = {
    ...
    // VCU registers (32-bit)
    {VR0, RegInfo{.fullWidthReg = VR0, .size = Sizes::_4_BYTES}},
    {VR1, RegInfo{.fullWidthReg = VR1, .size = Sizes::_4_BYTES}},
    {VR2, RegInfo{.fullWidthReg = VR2, .size = Sizes::_4_BYTES}},
    {VR3, RegInfo{.fullWidthReg = VR3, .size = Sizes::_4_BYTES}},
    {VR4, RegInfo{.fullWidthReg = VR4, .size = Sizes::_4_BYTES}},
    {VR5, RegInfo{.fullWidthReg = VR5, .size = Sizes::_4_BYTES}},
    {VR6, RegInfo{.fullWidthReg = VR6, .size = Sizes::_4_BYTES}},
    {VR7, RegInfo{.fullWidthReg = VR7, .size = Sizes::_4_BYTES}},
    {VR8, RegInfo{.fullWidthReg = VR8, .size = Sizes::_4_BYTES}},
    {VT0, RegInfo{.fullWidthReg = VT0, .size = Sizes::_4_BYTES}},
    {VT1, RegInfo{.fullWidthReg = VT1, .size = Sizes::_4_BYTES}},
    {VSTATUS, RegInfo{.fullWidthReg = VSTATUS, .size = Sizes::_4_BYTES}},
};
