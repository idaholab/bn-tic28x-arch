...
uint8_t VcuGetRegA_I(uint32_t data);
uint32_t VcuSetRegA_I(uint32_t opcode, uint8_t a);

uint8_t VcuGetRegA_II(uint32_t data);
uint32_t VcuSetRegA_II(uint32_t opcode, uint8_t a);

uint8_t VcuGetRegT(uint32_t data);
uint32_t VcuSetRegT(uint32_t opcode, uint8_t t);

uint16_t VcuGetImm16(uint32_t data);
uint32_t VcuSetImm16(uint32_t opcode, uint16_t imm);
...
class Mov16Mem16Rah final : public Instruction4Byte {
 public:
  Mov16Mem16Rah() : Instruction4Byte() {}
  ...
  static uint32_t SetMem16(uint8_t mem16);
  static uint8_t GetRegA(uint32_t data);
  static uint32_t SetRegA(uint8_t a);
...
class Mov32Loc32Imm16A final : public Instruction4Byte {
 public:
  Mov32Loc32Imm16A() : Instruction4Byte() {}
  ...
  static uint32_t SetImm16(uint16_t imm16);
...
class Mov32Loc32Imm16B final : public Instruction4Byte {
 public:
  Mov32Loc32Imm16B() : Instruction4Byte() {}
...
class Mov32Mem32Rah final : public Instruction4Byte {
 public:
  Mov32Mem32Rah() : Instruction4Byte() {}
...
class Mov32Mem32Stf final : public Instruction4Byte {
 public:
  Mov32Mem32Stf() : Instruction4Byte() {}
...
class Mov32RahMem32Cndf final : public Instruction4Byte {
 public:
  Mov32RahMem32Cndf() : Instruction4Byte() {}
...
class Mov32RahRbhCndf final : public Instruction4Byte {
 public:
  Mov32RahRbhCndf() : Instruction4Byte() {}
...
class Mov32StfMem32 final : public Instruction4Byte {
 public:
  Mov32StfMem32() : Instruction4Byte() {}
...
class Movd32RahMem32 final : public Instruction4Byte {
 public:
  Movd32RahMem32() : Instruction4Byte() {}
...
class MovizRah16FHiHex final : public Instruction4Byte {
 public:
  MovizRah16FHiHex() : Instruction4Byte() {}
  ...
  static uint8_t GetRegA(uint32_t data);
  static uint32_t SetRegA(uint8_t a);
  static uint16_t GetImm16Hex(uint32_t data);
  static uint32_t SetImm16Hex(uint16_t imm16_hex);
...
class Movst0Flag final : public Instruction2Byte {
 public:
  Movst0Flag() : Instruction2Byte() {}
  ...
  /* Helper Functions */
  static uint8_t GetFlag(uint32_t data);
  static uint32_t SetFlag(uint8_t flag);
...
class MovizRah16FLoHex final : public Instruction4Byte {
 public:
  MovizRah16FLoHex() : Instruction4Byte() {}
...
class Mpyf32RahRbhRch final : public Instruction4Byte {
 public:
  Mpyf32RahRbhRch() : Instruction4Byte() {}
...
class Mpyf32Rah16FHiRbh final : public Instruction4Byte {
 public:
  Mpyf32Rah16FHiRbh() : Instruction4Byte() {}
...
class Mpyf32RdhRehRfhMov32RahMem32 final : public Instruction4Byte {
 public:
  Mpyf32RdhRehRfhMov32RahMem32() : Instruction4Byte() {}
...
class Mpyf32RdhRehRfhMov32Mem32Rah final : public Instruction4Byte {
 public:
  Mpyf32RdhRehRfhMov32Mem32Rah() : Instruction4Byte() {}
...
class Mpyf32RahRbhRchSubf32RdhRehRfh final : public Instruction4Byte {
 public:
  Mpyf32RahRbhRchSubf32RdhRehRfh() : Instruction4Byte() {}
...
class Negf32RahRbhCndf final : public Instruction4Byte {
 public:
  Negf32RahRbhCndf() : Instruction4Byte() {}
...
class PopRb final : public Instruction2Byte {
 public:
  PopRb() : Instruction2Byte() {}
...
class PushRb final : public Instruction2Byte {
 public:
  PushRb() : Instruction2Byte() {}
...
class Restore final : public Instruction2Byte {
 public:
  Restore() : Instruction2Byte() {}
...
class RptbLabelLoc16 final : public Instruction4Byte {
 public:
  RptbLabelLoc16() : Instruction4Byte() {}
...
class SwapfRahRbhCndf final : public Instruction4Byte {
 public:
  SwapfRahRbhCndf() : Instruction4Byte() {}
  ...
  static uint8_t GetRegB(uint32_t data);
  static uint32_t SetRegB(uint8_t b);
  static uint8_t GetCndf(uint32_t data);
  static uint32_t SetCndf(uint8_t cndf);
...
class TesttfCndf final : public Instruction2Byte {
 public:
  TesttfCndf() : Instruction2Byte() {}
...
class Ui16tof32RahMem16 final : public Instruction4Byte {
 public:
  Ui16tof32RahMem16() : Instruction4Byte() {}
...
class Ui16tof32RahRbh final : public Instruction4Byte {
 public:
  Ui16tof32RahRbh() : Instruction4Byte() {}
...
class Ui32tof32RahMem32 final : public Instruction4Byte {
 public:
  Ui32tof32RahMem32() : Instruction4Byte() {}
...
class Ui32tof32RahRbh final : public Instruction4Byte {
 public:
  Ui32tof32RahRbh() : Instruction4Byte() {}
...
class ZeroRah final : public Instruction2Byte {
 public:
  ZeroRah() : Instruction2Byte() {}
...
class Zeroa final : public Instruction2Byte {
 public:
  Zeroa() : Instruction2Byte() {}
...
class Mov32RalMem32Cndf final : public Instruction4Byte {
 public:
  Mov32RalMem32Cndf() : Instruction4Byte() {}
...
class Movdd32RalMem32 final : public Instruction4Byte {
 public:
  Movdd32RalMem32() : Instruction4Byte() {}
...
class Movdd32RahMem32 final : public Instruction4Byte {
 public:
  Movdd32RahMem32() : Instruction4Byte() {}
...
class Mov32Mem32Ral final : public Instruction4Byte {
 public:
  Mov32Mem32Ral() : Instruction4Byte() {}
...
class MovixRal16i final : public Instruction4Byte {
 public:
  MovixRal16i() : Instruction4Byte() {}
  ...
  static uint8_t GetRegA(uint32_t data);
  static uint32_t SetRegA(uint8_t a);
  static uint16_t Get16i(uint32_t data);
  static uint32_t Set16i(uint16_t i);
...
class MovxiRal16i final : public Instruction4Byte {
 public:
  MovxiRal16i() : Instruction4Byte() {}
...
class Mpyf64RdReRfMov32RalMem32 final : public Instruction4Byte {
 public:
  Mpyf64RdReRfMov32RalMem32() : Instruction4Byte() {}
...
class Mpyf64RdReRfMov32Mem32Ral final : public Instruction4Byte {
 public:
  Mpyf64RdReRfMov32Mem32Ral() : Instruction4Byte() {}
...
class Addf64RdReRfMov32RalMem32 final : public Instruction4Byte {
 public:
  Addf64RdReRfMov32RalMem32() : Instruction4Byte() {}
...
class Addf64RdReRfMov32Mem32Ral final : public Instruction4Byte {
 public:
  Addf64RdReRfMov32Mem32Ral() : Instruction4Byte() {}
...
class Subf64RdReRfMov32RalMem32 final : public Instruction4Byte {
 public:
  Subf64RdReRfMov32RalMem32() : Instruction4Byte() {}
...
class Subf64RdReRfMov32Mem32Ral final : public Instruction4Byte {
 public:
  Subf64RdReRfMov32Mem32Ral() : Instruction4Byte() {}
...
class Macf64R3R2RdReRfMov32RalMem32 final : public Instruction4Byte {
 public:
  Macf64R3R2RdReRfMov32RalMem32() : Instruction4Byte() {}
...
class Macf64R7R6RdReRfMov32RalMem32 final : public Instruction4Byte {
 public:
  Macf64R7R6RdReRfMov32RalMem32() : Instruction4Byte() {}
...
class Mpyf64RdReRfMov32RahMem32 final : public Instruction4Byte {
 public:
  Mpyf64RdReRfMov32RahMem32() : Instruction4Byte() {}
...
class Mpyf64RdReRfMov32Mem32Rah final : public Instruction4Byte {
 public:
  Mpyf64RdReRfMov32Mem32Rah() : Instruction4Byte() {}
...
class Addf64RdReRfMov32RahMem32 final : public Instruction4Byte {
 public:
  Addf64RdReRfMov32RahMem32() : Instruction4Byte() {}
...
class Addf64RdReRfMov32Mem32Rah final : public Instruction4Byte {
 public:
  Addf64RdReRfMov32Mem32Rah() : Instruction4Byte() {}
...
class Subf64RdReRfMov32RahMem32 final : public Instruction4Byte {
 public:
  Subf64RdReRfMov32RahMem32() : Instruction4Byte() {}
...
class Subf64RdReRfMov32Mem32Rah final : public Instruction4Byte {
 public:
  Subf64RdReRfMov32Mem32Rah() : Instruction4Byte() {}
...
class Macf64R3R2RdReRfMov32RahMem32 final : public Instruction4Byte {
 public:
  Macf64R3R2RdReRfMov32RahMem32() : Instruction4Byte() {}
...
class Macf64R7R6RdReRfMov32RahMem32 final : public Instruction4Byte {
 public:
  Macf64R7R6RdReRfMov32RahMem32() : Instruction4Byte() {}
...
class Mpyf64RaRbRcAddf64RdReRf final : public Instruction4Byte {
 public:
  Mpyf64RaRbRcAddf64RdReRf() : Instruction4Byte() {}
...
class Mpyf64RaRbRcSubf64RdReRf final : public Instruction4Byte {
 public:
  Mpyf64RaRbRcSubf64RdReRf() : Instruction4Byte() {}
...
class Mpyf64RaRbRc final : public Instruction4Byte {
 public:
  Mpyf64RaRbRc() : Instruction4Byte() {}
...
class Addf64RaRbRc final : public Instruction4Byte {
 public:
  Addf64RaRbRc() : Instruction4Byte() {}
...
class Subf64RaRbRc final : public Instruction4Byte {
 public:
  Subf64RaRbRc() : Instruction4Byte() {}
...
class Mpyf64RaRb16F final : public Instruction4Byte {
 public:
  Mpyf64RaRb16F() : Instruction4Byte() {}
  ...
  static uint8_t GetRegB(uint32_t data);
  static uint32_t SetRegB(uint8_t b);
  static uint16_t Get16F(uint32_t data);
  static uint32_t Set16F(uint16_t imm);
...
class Addf64RaRb16F final : public Instruction4Byte {
 public:
  Addf64RaRb16F() : Instruction4Byte() {}
...
class Subf64Ra16FRb final : public Instruction4Byte {
 public:
  Subf64Ra16FRb() : Instruction4Byte() {}
...
class Cmpf64RaRb final : public Instruction4Byte {
 public:
  Cmpf64RaRb() : Instruction4Byte() {}
...
class Cmpf64Ra16F final : public Instruction4Byte {
 public:
  Cmpf64Ra16F() : Instruction4Byte() {}
...
class Cmpf64Ra0 final : public Instruction2Byte {
 public:
  Cmpf64Ra0() : Instruction2Byte() {}
...
class Maxf64RaRb final : public Instruction4Byte {
 public:
  Maxf64RaRb() : Instruction4Byte() {}
...
class Maxf64RaRbMov64RcRd final : public Instruction4Byte {
 public:
  Maxf64RaRbMov64RcRd() : Instruction4Byte() {}
...
class Maxf64Ra16F final : public Instruction4Byte {
 public:
  Maxf64Ra16F() : Instruction4Byte() {}
...
class Minf64RaRb final : public Instruction4Byte {
 public:
  Minf64RaRb() : Instruction4Byte() {}
...
class Minf64RaRbMov64RcRd final : public Instruction4Byte {
 public:
  Minf64RaRbMov64RcRd() : Instruction4Byte() {}
...
class Minf64Ra16F final : public Instruction4Byte {
 public:
  Minf64Ra16F() : Instruction4Byte() {}
...
class F64toi32RahRb final : public Instruction4Byte {
 public:
  F64toi32RahRb() : Instruction4Byte() {}
...
class F64toui32RahRb final : public Instruction4Byte {
 public:
  F64toui32RahRb() : Instruction4Byte() {}
...
class I32tof64RaMem32 final : public Instruction4Byte {
 public:
  I32tof64RaMem32() : Instruction4Byte() {}
  ...
  static uint8_t GetRegA(uint32_t data);
  static uint32_t SetRegA(uint8_t a);
  static uint8_t GetMem(uint32_t data);
  static uint32_t SetMem(uint8_t mem);
...
class I32tof64RaRbh final : public Instruction4Byte {
 public:
  I32tof64RaRbh() : Instruction4Byte() {}
...
class Ui32tof64RaMem32 final : public Instruction4Byte {
 public:
  Ui32tof64RaMem32() : Instruction4Byte() {}
...
class F64toui64RaRb final : public Instruction4Byte {
 public:
  F64toui64RaRb() : Instruction4Byte() {}
...
class Ui64tof64RaRb final : public Instruction4Byte {
 public:
  Ui64tof64RaRb() : Instruction4Byte() {}
...
class Fracf64RaRb final : public Instruction4Byte {
 public:
  Fracf64RaRb() : Instruction4Byte() {}
...
class F64tof32RahRb final : public Instruction4Byte {
 public:
  F64tof32RahRb() : Instruction4Byte() {}
...
class F32tof64RaRbh final : public Instruction4Byte {
 public:
  F32tof64RaRbh() : Instruction4Byte() {}
...
class F32tof64RaMem32 final : public Instruction4Byte {
 public:
  F32tof64RaMem32() : Instruction4Byte() {}
...
class F32dtof64RaMem32 final : public Instruction4Byte {
 public:
  F32dtof64RaMem32() : Instruction4Byte() {}
...
class Absf64RaRb final : public Instruction4Byte {
 public:
  Absf64RaRb() : Instruction4Byte() {}
...
class Negf64RaRbCndf final : public Instruction4Byte {
 public:
  Negf64RaRbCndf() : Instruction4Byte() {}
...
class Mov64RaRbCndf final : public Instruction4Byte {
 public:
  Mov64RaRbCndf() : Instruction4Byte() {}
...
class Eisqrtf64RaRb final : public Instruction4Byte {
 public:
  Eisqrtf64RaRb() : Instruction4Byte() {}
...
class Einvf64RaRb final : public Instruction4Byte {
 public:
  Einvf64RaRb() : Instruction4Byte() {}
...
class VclearVra final : public Instruction4Byte {
 public:
  VclearVra() : Instruction4Byte() {}
...
class Vclearall final : public Instruction4Byte {
 public:
  Vclearall() : Instruction4Byte() {}
...
class Vclrovfr final : public Instruction2Byte {
 public:
  Vclrovfr() : Instruction2Byte() {}
...
class Vmov16Mem16Vral final : public Instruction4Byte {
 public:
  Vmov16Mem16Vral() : Instruction4Byte() {}
...
class Vmov16VralMem16 final : public Instruction4Byte {
 public:
  Vmov16VralMem16() : Instruction4Byte() {}
...
class Vmov32Mem32Vra final : public Instruction4Byte {
 public:
  Vmov32Mem32Vra() : Instruction4Byte() {}
...
class Vmov32Mem32Vstatus final : public Instruction4Byte {
 public:
  Vmov32Mem32Vstatus() : Instruction4Byte() {}
...
class Vmov32Mem32Vta final : public Instruction4Byte {
 public:
  Vmov32Mem32Vta() : Instruction4Byte() {}
  ...
  /* Helper Functions */
  static uint8_t GetRegT(uint32_t data);
  static uint32_t SetRegT(uint8_t t);
  static uint8_t GetMem32(uint32_t data);
  static uint32_t SetMem32(uint8_t mem);
...
class Vmov32VraMem32 final : public Instruction4Byte {
 public:
  Vmov32VraMem32() : Instruction4Byte() {}
...
class Vmov32VstatusMem32 final : public Instruction4Byte {
 public:
  Vmov32VstatusMem32() : Instruction4Byte() {}
...
class Vmov32VtaMem32 final : public Instruction4Byte {
 public:
  Vmov32VtaMem32() : Instruction4Byte() {}
...
class VmovixVraImm16 final : public Instruction4Byte {
 public:
  VmovixVraImm16() : Instruction4Byte() {}
...
class VmovziVraImm16 final : public Instruction4Byte {
 public:
  VmovziVraImm16() : Instruction4Byte() {}
...
class VmovxiVraImm16 final : public Instruction4Byte {
 public:
  VmovxiVraImm16() : Instruction4Byte() {}
...
class Vrndoff final : public Instruction2Byte {
 public:
  Vrndoff() : Instruction2Byte() {}
...
class Vrndon final : public Instruction2Byte {
 public:
  Vrndon() : Instruction2Byte() {}
...
class Vsatoff final : public Instruction2Byte {
 public:
  Vsatoff() : Instruction2Byte() {}
...
class Vsaton final : public Instruction2Byte {
 public:
  Vsaton() : Instruction2Byte() {}
...
class Vsetshl5bit final : public Instruction2Byte {
 public:
  Vsetshl5bit() : Instruction2Byte() {}
...
class Vsetshr5bit final : public Instruction2Byte {
 public:
  Vsetshr5bit() : Instruction2Byte() {}
...
class Vashr32Vra5bit final : public Instruction4Byte {
 public:
  Vashr32Vra5bit() : Instruction4Byte() {}
...
class Vlshr32Vra5bit final : public Instruction4Byte {
 public:
  Vlshr32Vra5bit() : Instruction4Byte() {}
...
class VnegVra final : public Instruction2Byte {
 public:
  VnegVra() : Instruction2Byte() {}

  /* Instruction Data */
  // Encoding: 1110 0101 0001 aaaa (bits 15-4 fixed, bits 3-0 = VRa)
...
class VcaddVr7Vr6Vr5Vr4 final : public Instruction2Byte {
 public:
  VcaddVr7Vr6Vr5Vr4() : Instruction2Byte() {}

  /* Instruction Data */
  // Encoding: 1110 0101 0010 1010 (all bits fixed, no variable fields)
  // Inputs (implicit): VR7=Re(X), VR6=Im(X), VR5=Re(Y), VR4=Im(Y)
  // Outputs (implicit): VR7=Re(Z)=Re(X)+(Re(Y)>>SHIFTR),
  //                     VR6=Im(Z)=Im(X)+(Im(Y)>>SHIFTR)
  // VSTATUS fields used: SHIFTR[4:0], RND[11], SAT[10]
  // Flags modified: OVFR (VSTATUS[12]), OVFI (VSTATUS[13])
...
class VccmacVr5Vr4Vr3Vr2Vr1Vr0Vmov32VraMem32 final : public Instruction4Byte {
 public:
  VccmacVr5Vr4Vr3Vr2Vr1Vr0Vmov32VraMem32() : Instruction4Byte() {}
  ...
  // Flags modified: OVFR (VSTATUS[12]), OVFI (VSTATUS[13])
  static constexpr uint32_t opcode =
      Opcodes::VCCMAC_VR5_VR4_VR3_VR2_VR1_VR0_VMOV32_VRA_MEM32;
  static constexpr uint32_t opcode_mask = OpcodeMasks::MASK_FFFFF000;
  static constexpr auto full_name = "VccmacVr5Vr4Vr3Vr2Vr1Vr0Vmov32VraMem32";
  static constexpr auto mnemonic = "vccmac";
  static constexpr bool repeatable = false;
  static constexpr ObjectMode objmode = OBJMODE_1;
...
class VccmpyVr3Vr2Vr1Vr0Vmov32VraMem32 final : public Instruction4Byte {
 public:
  VccmpyVr3Vr2Vr1Vr0Vmov32VraMem32() : Instruction4Byte() {}
  ...
  // Flags modified: OVFR (VSTATUS[12]), OVFI (VSTATUS[13])
  static constexpr uint32_t opcode =
      Opcodes::VCCMPY_VR3_VR2_VR1_VR0_VMOV32_VRA_MEM32;
  static constexpr uint32_t opcode_mask = OpcodeMasks::MASK_FFFFF000;
  static constexpr auto full_name = "VccmpyVr3Vr2Vr1Vr0Vmov32VraMem32";
  static constexpr auto mnemonic = "vccmpy";
  static constexpr bool repeatable = false;
  static constexpr ObjectMode objmode = OBJMODE_1;
...
class VccmpyVr3Vr2Vr1Vr0Vmov32VraMem32Load final : public Instruction4Byte {
 public:
  VccmpyVr3Vr2Vr1Vr0Vmov32VraMem32Load() : Instruction4Byte() {}
  ...
  // Flags modified: OVFR (VSTATUS[12]), OVFI (VSTATUS[13])
  static constexpr uint32_t opcode =
      Opcodes::VCCMPY_VR3_VR2_VR1_VR0_VMOV32_VRA_MEM32_LOAD;
  static constexpr uint32_t opcode_mask = OpcodeMasks::MASK_FFFFF000;
  static constexpr auto full_name = "VccmpyVr3Vr2Vr1Vr0Vmov32VraMem32Load";
  static constexpr auto mnemonic = "vccmpy";
  static constexpr bool repeatable = false;
  static constexpr ObjectMode objmode = OBJMODE_1;
...
class Vcdadd16Vr5Vr4Vr3Vr2 final : public Instruction2Byte {
 public:
  Vcdadd16Vr5Vr4Vr3Vr2() : Instruction2Byte() {}

  /* Instruction Data */
  // Encoding: 1110 0101 0000 0100 (all bits fixed, no variable fields)
  // Complex 16 + 32 = 16 Addition
  // Inputs (implicit):
  //   VR4H = Re(X) (16-bit), VR4L = Im(X) (16-bit)
  //   VR3 = Re(Y) (32-bit), VR2 = Im(Y) (32-bit)
  // Outputs (implicit):
  //   VR5H = Re(Z) = Re(X) + (Re(Y) >> SHIFTR)
  //   VR5L = Im(Z) = Im(X) + (Im(Y) >> SHIFTR)
  // VSTATUS fields used: CPACK[14], SHIFTL[9:5], SHIFTR[4:0], RND[11], SAT[10]
  // Flags modified: OVFR (VSTATUS[12]), OVFI (VSTATUS[13])
  static constexpr uint32_t opcode = Opcodes::VCDADD16_VR5_VR4_VR3_VR2;
  static constexpr uint32_t opcode_mask = OpcodeMasks::MASK_FFFF;
  static constexpr auto full_name = "Vcdadd16Vr5Vr4Vr3Vr2";
  static constexpr auto mnemonic = "vcdadd16";
  static constexpr bool repeatable = false;
  static constexpr ObjectMode objmode = OBJMODE_1;
...
class Vcdadd16Vr5Vr4Vr3Vr2Vmov32VraMem32 final : public Instruction4Byte {
 public:
  Vcdadd16Vr5Vr4Vr3Vr2Vmov32VraMem32() : Instruction4Byte() {}
  ...
  //     bits [11:8] = aaaa -> VRa index (destination for parallel load)
  //     bits [7:0]  = mmmm mmmm -> mem32 addressing mode bits
  // VRa cannot be VR5 (5) or VR8 (8).
  // Complex 16 + 32 = 16 Addition with parallel load.
  // Inputs (implicit):
  //   VR4H = Re(X) (16-bit), VR4L = Im(X) (16-bit)
  //   VR3 = Re(Y) (32-bit), VR2 = Im(Y) (32-bit)
  // Outputs (implicit):
  ...
  // Flags modified: OVFR (VSTATUS[12]), OVFI (VSTATUS[13])
  static constexpr uint32_t opcode =
      Opcodes::VCDADD16_VR5_VR4_VR3_VR2_VMOV32_VRA_MEM32;
  static constexpr uint32_t opcode_mask = OpcodeMasks::MASK_FFFFF000;
  static constexpr auto full_name = "Vcdadd16Vr5Vr4Vr3Vr2Vmov32VraMem32";
  static constexpr auto mnemonic = "vcdadd16";
  static constexpr bool repeatable = false;
  static constexpr ObjectMode objmode = OBJMODE_1;
...
class Vcdsub16Vr6Vr4Vr3Vr2Vmov32VraMem32 final : public Instruction4Byte {
 public:
  Vcdsub16Vr6Vr4Vr3Vr2Vmov32VraMem32() : Instruction4Byte() {}
  ...
  //     bits [11:8] = aaaa -> VRa index (destination for parallel load)
  //     bits [7:0]  = mmmm mmmm -> mem32 addressing mode bits
  // VRa cannot be VR6 (6) or VR8 (8).
  // Complex 16 - 32 = 16 Subtraction with parallel load.
  // Inputs (implicit):
  //   VR4H = Re(X) (16-bit), VR4L = Im(X) (16-bit)
  //   VR3 = Re(Y) (32-bit), VR2 = Im(Y) (32-bit)
  // Outputs (implicit):
  //   VR6H = Re(Z) = Re(X) - (Re(Y) >> SHIFTR)
  //   VR6L = Im(Z) = Im(X) - (Im(Y) >> SHIFTR)
  // Parallel: VRa = [mem32]
  // VSTATUS fields used: CPACK[14], SHIFTL[9:5], SHIFTR[4:0], RND[11], SAT[10]
  // Flags modified: OVFR (VSTATUS[12]), OVFI (VSTATUS[13])
  static constexpr uint32_t opcode =
      Opcodes::VCDSUB16_VR6_VR4_VR3_VR2_VMOV32_VRA_MEM32;
  static constexpr uint32_t opcode_mask = OpcodeMasks::MASK_FFFFF000;
  static constexpr auto full_name = "Vcdsub16Vr6Vr4Vr3Vr2Vmov32VraMem32";
  static constexpr auto mnemonic = "vcdsub16";
  static constexpr bool repeatable = false;
  static constexpr ObjectMode objmode = OBJMODE_1;
...
class Vcdsub16Vr6Vr4Vr3Vr2 final : public Instruction2Byte {
 public:
  Vcdsub16Vr6Vr4Vr3Vr2() : Instruction2Byte() {}

  /* Instruction Data */
  // Encoding: 1110 0101 0000 0101 (all bits fixed, no variable fields)
  // Complex 16 - 32 = 16 Subtraction
  // Inputs (implicit):
  //   VR4H = Re(X) (16-bit), VR4L = Im(X) (16-bit)
  //   VR3 = Re(Y) (32-bit), VR2 = Im(Y) (32-bit)
  // Outputs (implicit):
  ...
  // VSTATUS fields used: CPACK[14], SHIFTL[9:5], SHIFTR[4:0], RND[11], SAT[10]
  // Flags modified: OVFR (VSTATUS[12]), OVFI (VSTATUS[13])
  static constexpr uint32_t opcode = Opcodes::VCDSUB16_VR6_VR4_VR3_VR2;
  static constexpr uint32_t opcode_mask = OpcodeMasks::MASK_FFFF;
  static constexpr auto full_name = "Vcdsub16Vr6Vr4Vr3Vr2";
  static constexpr auto mnemonic = "vcdsub16";
  static constexpr bool repeatable = false;
  static constexpr ObjectMode objmode = OBJMODE_1;
...
class VcflipVra final : public Instruction2Byte {
 public:
  VcflipVra() : Instruction2Byte() {}

  /* Instruction Data */
  // Encoding: 1010 0001 0000 aaaa (bits 15-4 fixed, bits 3-0 = VRa)
  // Swap VRaL and VRaH (swap upper and lower half of VCU register).
  // VRa cannot be VR8.
  // Flags modified: None
  static constexpr uint32_t opcode = Opcodes::VCFLIP_VRA;
  static constexpr uint32_t opcode_mask = OpcodeMasks::MASK_FFF0;
  static constexpr auto full_name = "VcflipVra";
  static constexpr auto mnemonic = "vcflip";
  static constexpr bool repeatable = false;
  static constexpr ObjectMode objmode = OBJMODE_1;
...
class VcmacVr5Vr4Vr3Vr2Vr1Vr0 final : public Instruction2Byte {
 public:
  VcmacVr5Vr4Vr3Vr2Vr1Vr0() : Instruction2Byte() {}

  /* Instruction Data */
  // Encoding: 1110 0101 0000 0001 (all bits fixed, no variable fields)
  ...
  // VSTATUS fields used: SHIFTR[4:0], RND[11], SAT[10], CPACK[14]
  // Flags modified: OVFR (VSTATUS[12]), OVFI (VSTATUS[13])
  static constexpr uint32_t opcode = Opcodes::VCMAC_VR5_VR4_VR3_VR2_VR1_VR0;
  static constexpr uint32_t opcode_mask = OpcodeMasks::MASK_FFFF;
  static constexpr auto full_name = "VcmacVr5Vr4Vr3Vr2Vr1Vr0";
...
class VcmacVr7Vr6Vr5Vr4Mem32Xar7Postinc final : public Instruction4Byte {
 public:
  VcmacVr7Vr6Vr5Vr4Mem32Xar7Postinc() : Instruction4Byte() {}
  ...
  // Must be used with RPT || (single repeat instruction)
  // Operands: VR7, VR6, VR5, VR4, mem32, *XAR7++
  // On odd cycles: accumulate alternates to VR5/VR4
  // On even cycles: accumulate alternates to VR7/VR6
  // VR0-VR3 used as temporary storage
  // *XAR7++ is implicit (XAR7 post-incremented each cycle)
  // VSTATUS fields used: SHIFTR[4:0], RND[11], SAT[10], CPACK[14]
  // Flags modified: OVFR (VSTATUS[12]), OVFI (VSTATUS[13])
  // Pipeline: 2p + N cycles (2-pipeline instruction)
  static constexpr uint32_t opcode =
      Opcodes::VCMAC_VR7_VR6_VR5_VR4_MEM32_XAR7_POSTINC;
  static constexpr uint32_t opcode_mask = OpcodeMasks::MASK_FFFFFF00;
  static constexpr auto full_name = "VcmacVr7Vr6Vr5Vr4Mem32Xar7Postinc";
  static constexpr auto mnemonic = "vcmac";
  static constexpr bool repeatable = true;
  static constexpr ObjectMode objmode = OBJMODE_1;
...
class VcmpyVr3Vr2Vr1Vr0 final : public Instruction2Byte {
 public:
  VcmpyVr3Vr2Vr1Vr0() : Instruction2Byte() {}

  /* Instruction Data */
  // Encoding: 1110 0101 0000 0000 (all bits fixed, no variable fields)
  // Complex 16 x 16 = 32-bit Multiply
  // Inputs (implicit): VR0 (first complex operand), VR1 (second complex
  // operand) Outputs (implicit): VR3=Re(Z), VR2=Im(Z) if(CPACK==0):
  // VR3=VR0H*VR1H-VR0L*VR1L, VR2=VR0H*VR1L+VR0L*VR1H if(CPACK==1):
  // VR3=VR0L*VR1L-VR0H*VR1H, VR2=VR0L*VR1H+VR0H*VR1L VSTATUS fields used:
  // CPACK[14] Flags modified: OVFR (VSTATUS[12]), OVFI (VSTATUS[13])
  static constexpr uint32_t opcode = Opcodes::VCMPY_VR3_VR2_VR1_VR0;
  static constexpr uint32_t opcode_mask = OpcodeMasks::MASK_FFFF;
  static constexpr auto full_name = "VcmpyVr3Vr2Vr1Vr0";
  static constexpr auto mnemonic = "vcmpy";
  static constexpr bool repeatable = false;
  static constexpr ObjectMode objmode = OBJMODE_1;
...
class VcmpyVr3Vr2Vr1Vr0Vmov32Mem32Vra final : public Instruction4Byte {
 public:
  VcmpyVr3Vr2Vr1Vr0Vmov32Mem32Vra() : Instruction4Byte() {}
  ...
  //     bits [7:0]  = mmmm mmmm -> mem32 addressing mode bits
  // VRa cannot be VR3 (3), VR2 (2), or VR8 (8).
  // Complex 16 x 16 = 32-bit Multiply with parallel 32-bit store.
  // Inputs (implicit): VR0 (first complex operand), VR1 (second complex
  // operand) Outputs (implicit): VR3=Re(Z), VR2=Im(Z), [mem32]=VRa
  // if(CPACK==0): VR3=VR0H*VR1H-VR0L*VR1L, VR2=VR0H*VR1L+VR0L*VR1H
  // if(CPACK==1): VR3=VR0L*VR1L-VR0H*VR1H, VR2=VR0L*VR1H+VR0H*VR1L
  ...
  // Flags modified: OVFR (VSTATUS[12]), OVFI (VSTATUS[13])
  static constexpr uint32_t opcode =
      Opcodes::VCMPY_VR3_VR2_VR1_VR0_VMOV32_MEM32_VRA;
  static constexpr uint32_t opcode_mask = OpcodeMasks::MASK_FFFFF000;
  static constexpr auto full_name = "VcmpyVr3Vr2Vr1Vr0Vmov32Mem32Vra";
  static constexpr auto mnemonic = "vcmpy";
  static constexpr bool repeatable = false;
  static constexpr ObjectMode objmode = OBJMODE_1;
...
class VcmpyVr3Vr2Vr1Vr0Vmov32VraMem32 final : public Instruction4Byte {
 public:
  VcmpyVr3Vr2Vr1Vr0Vmov32VraMem32() : Instruction4Byte() {}

  /* Instruction Data */
  // Encoding:
  //   LSW: 1110 0011 1111 0110 = 0xE3F6 (bits [31:16])
  //   MSW: 0000 aaaa mmmm mmmm (bits [15:0])
  //     bits [11:8] = aaaa -> VRa index (destination register for load)
  //     bits [7:0]  = mmmm mmmm -> mem32 addressing mode bits
  // VRa cannot be VR2 (2), VR3 (3), or VR8 (8).
  // Complex 16 x 16 = 32-bit Multiply with parallel 32-bit load.
  // Inputs (implicit): VR0 (first complex operand), VR1 (second complex
  // operand) Outputs (implicit): VR3=Re(Z), VR2=Im(Z), VRa=[mem32]
  // if(CPACK==0): VR3=VR0H*VR1H-VR0L*VR1L, VR2=VR0H*VR1L+VR0L*VR1H
  // if(CPACK==1): VR3=VR0L*VR1L-VR0H*VR1H, VR2=VR0L*VR1H+VR0H*VR1L
  ...
  // Flags modified: OVFR (VSTATUS[12]), OVFI (VSTATUS[13])
  static constexpr uint32_t opcode =
      Opcodes::VCMPY_VR3_VR2_VR1_VR0_VMOV32_VRA_MEM32;
  static constexpr uint32_t opcode_mask = OpcodeMasks::MASK_FFFFF000;
  static constexpr auto full_name = "VcmpyVr3Vr2Vr1Vr0Vmov32VraMem32";
  static constexpr auto mnemonic = "vcmpy";
  static constexpr bool repeatable = false;
  static constexpr ObjectMode objmode = OBJMODE_1;
